...
hbar = 1.
g = 0.0 # constante de acoplamiento, mide qué tan fuerte es la interacción entre el átomo y un fotón en la cavidad
...
# Hamiltoniano total
H = H_cavidad + H_bombeo + H_atomo + H_atomo_cavidad
...
create_file(filename=f"cavidad+atomo+bombeo+k{"y" if gamma>0 else ""}.csv", t=t, probs=probs, expects=(N_expect,X_expect,P_expect), params=parametros)
