...
detuning_al = 0. # detuning entre frecuencia del átomo y frecuencia del láser
...
#=================================
# con disipación, sin decaimiento
#=================================
parametros = {
    'g': g,
    'kappa': kappa,
...
H_cavidad = hbar * detuning_ca * (aa*a + 1/2) # Hamiltoniano del oscilador armónico cuántico (cavidad)
...
# Hamiltoniano total
H = H_cavidad + H_atomo + H_atomo_laser + H_atomo_cavidad
...
from auxiliares import create_file
create_file(filename='cavidad+atomo+control+k.csv', t=t, probs=probs, expects=(N_expect,X_expect,P_expect), params=parametros)
...
if os.path.exists('func.py'):
    os.remove('func.py')
#=================================
# con disipación, con decaimiento
#=================================
parametros = {
    'g': g,
    'kappa': kappa,
...
from auxiliares import create_file
create_file(filename='cavidad+atomo+control+ky.csv', t=t, probs=probs, expects=(N_expect,X_expect,P_expect), params=parametros)