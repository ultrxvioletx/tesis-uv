...
if detuning_bc != 0.0:
    ...
    H_atomo = (hbar/2) * (detuning_bc + detuning_ca) * (sigma_ee - sigma_gg)
elif detuning_ca != 0.0:
    H_cavidad = 0
    H_atomo = (hbar/2) * detuning_ca * (sigma_ee - sigma_gg)
elif detuning_al != 0.0:
    H_cavidad = hbar * detuning_al * (aa*a + 1/2)
    H_atomo = (hbar/2) * (detuning_al - detuning_ca) * (sigma_ee - sigma_gg)
