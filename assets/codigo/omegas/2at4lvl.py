...
Omega_EE = factor*(rabi_c**2 / gamma_e) # fuerza del intercambio/bloqueo |p,s> <-> |s,p|
...
ee1 = sigma1(3,2) * sigma2(2,3) # at1 sube |s>->|p>, at2 baja |p>->|s>
ee2 = sigma1(2,3) * sigma2(3,2) # at1 baja |p>->|s>, at2 sube |s>->|p>
