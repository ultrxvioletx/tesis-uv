...
Ahora que hemos explicado la dinámica de los sistemas aislados, se procede a estudiar la respuesta de un único átomo de tres niveles ($kg <-> ke <-> ks$) dentro de la cavidad óptica bombeada. En esta configuración en cascada, al modo de la cavidad se le aplica un barrido de detuning del láser de prueba, $Dpa$, acoplando la transición inferior $kg <-> ke$, y considerando que el láser de control y la transición superior $ke <-> ks$ están en perfecta resonacia ($Dac = 0$), como se muestra en la @fig:1at4lvl_sistema.
...
#figure(
  ...
  caption: [Diagrama de la interacción de un átomo de tres niveles con un campo electromagético y en cuasiresonancia con la cavidad, con detuning $Dpa$.]
) <fig:1at4lvl_sistema>
...
A diferencia del sistema de _dos_ niveles anterior, la presencia de más de una fuente de excitación permite que surjan fenómenos de interferencia cuántica y coherencia atómica, tales como el desdoblamiento de Autler-Townes y la Transparencia Inducida Electromagnética (EIT) @fleischhauer_electromagnetically_2005. En la figura @fig:deltas_1at4lvl_conrabi se muestra una alteración en la estructura de los niveles atómicos, como consecuencia de dichos fenómenos.
