...
Ahora que tenemos claras las propiedades interesantes de los átomos de Rydberg, queremos ver cómo interaccionan entre sí. Cuando dos átomos neutros se encuentran una distancia $R >> a_0$ (no confundir $R$ con la constante de Rydberg $ryd$), el solapamiento de sus nubes electrónicas es despreciable y los efectos de intercambio pueden omitirse. Sin embargo, a distancias macroscópicas, los átomos interactúan a través del acoplamiento de sus momentos dipolares electromagnéticos que fluctúan, y la contribución que domina en la interacción de largo alcance viene del acoplamiento entre sus dipolos eléctricos.
