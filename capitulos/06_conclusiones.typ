...
Se demostró numéricamente que la combinación de electrodinámica cuántica de cavidades (CQED) con las interacciones de los átomos de Rydberg ofrece un control sobre la luz y la materia a nivel cuántico. Se puede convertir una cavidad óptica en un sistema que emite fotones de uno en uno, debido al bloqueo, lo que podría tener aplicaciones en el desarrollo de fuentes de fotones individuales o en la implementación de compuertas lógicas para el procesamiento de información cuántica.